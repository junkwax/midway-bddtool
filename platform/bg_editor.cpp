...
bool g_stage_start_ground_enabled = false;
int  g_stage_start_ground_y = 200;
bool g_stage_start_camera_patch_bgnd = true;
char g_stage_start_bgnd_path[512] = "";
char g_stage_start_status[512] = "";
bool g_match_start_fighter_box_visible = false;
int  g_match_start_fighter_box_x = 176;
int  g_match_start_fighter_box_y = 88;
int  g_match_start_fighter_box_w = 48;
int  g_match_start_fighter_box_h = 112;
...
bool g_module_bounds_mouse_capture = false;
bool g_game_view_focus_module_enabled = true;
int  g_game_view_focus_module_idx = -1;

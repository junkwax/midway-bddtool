...
static void menu_bar_diag_tooltip(const Mk2Diag *d, int hard, int cautions)
{
    ...
    if (hard == 0 && cautions == 0) {
        ...
        if (d->odd_width_images) ImGui::TextColored(ImVec4(1,0.45f,0.30f,1), "%d sprite(s) with width not divisible by 4 shear in game (%s)", d->odd_width_images, d->odd_width_label);
